...
class Registry(models.Model):
    ...
    client_of = models.ForeignKey(
        Advogado,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name='registry_client_of',
    )
...
class RegistryAddress(models.Model):
    registry = models.ForeignKey(
        Registry, models.CASCADE, related_name='registry_address'
    )
...
class RegistryContact(models.Model):
    registry = models.ForeignKey(
        Registry, models.CASCADE, related_name='registry_contact'
    )
