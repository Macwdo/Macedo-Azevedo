...
class TjRjScraping:
    ...
    def last_process_moviment(self):
        ...
        try:
            ...
            logger.info(f'Success waiting site load - {self.numero_processo}')
        ...
        try:
            changes = self.searchWait(
                10,
                By.XPATH,
                self.paths['tipoN']['unica']['dados']['last_change'],
            ).text
        ...
        try:
            ...
            raise Exception(f'Error to handle data - {self.numero_processo}')
