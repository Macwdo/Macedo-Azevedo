...
from .serializers import (
    ProcessosAnexosSerializer,
    ProcessosAssuntosSerializer,
    ProcessosHonorariosSerializer,
...
class ProcessosViewSet(ModelViewSet):
    ...
    def finalizar(self, request, pk):
        ...
        if not processo.finalizado:
            ...
            return Response(
                data={'detail': 'este processo ja foi finalizado'},
    ...
    def get_queryset(self):
        ...
        if lawyer:
            lawsuits = lawsuits.filter(advogado_responsavel_id=lawyer)
